...
@Repository
public class UpdateCarritoPersistenceAdapter implements UpdateCarritoOutputPort {

    private final CarritoR2dbcRepository r2dbcRepository;
    private final CarritoPersistenceMapper mapper;

    public UpdateCarritoPersistenceAdapter(CarritoR2dbcRepository r2dbcRepository, CarritoPersistenceMapper mapper) {
