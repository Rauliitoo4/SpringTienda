...
@Repository
public class CreateProductPersistenceAdapter implements CreateProductRepository {

    private final ProductR2dbcRepository jpaRepository;
    private final ProductPersistenceMapper mapper;

    public CreateProductPersistenceAdapter(ProductR2dbcRepository jpaRepository,
