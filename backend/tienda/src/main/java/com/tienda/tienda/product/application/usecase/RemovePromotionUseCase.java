...
public class RemovePromotionUseCase {
    ...
    public RemovePromotionUseCase(ProductRepository productRepository, ProductPromotionRepository productPromotionRepository, PromotionLoader promotionLoader, ProductResponseMapper mapper, LineaCarritoService lineaCarritoService) {
