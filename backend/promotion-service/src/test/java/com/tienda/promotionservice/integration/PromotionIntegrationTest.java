package com.tienda.promotionservice.integration;

import com.tienda.promotionservice.application.usecase.*;
...
class PromotionIntegrationTest {
    ...
    @Autowired private CreatePromotionUseCase createPromotionUseCase;
    @Autowired private GetPromotionUseCase getPromotionUseCase;
    @Autowired private UpdatePromotionUseCase updatePromotionUseCase;
    @Autowired private DeletePromotionUseCase deletePromotionUseCase;
    ...
    void createPromotion_shouldSaveInDB() {
        Promotion result = createPromotionTest();
    ...
    @Test
    void getAllPromotions_shouldReturnPromotionsFromDB() {
        createPromotionTest();
    ...
    @Test
    void getPromotionById_shouldReturnPromotionFromDB() {
        Promotion created = createPromotionTest();
